...
int StatNcFile::initializeNcfile(const std::string filename, const util::TimeWindow timeWindow,
                    ...
                    std::vector<float> bin_lons,
                    std::vector<float> bin_lats) {
...
int StatNcFile::writeByDomains(const std::string filename, const std::string group, const std::string variable,
...
int StatNcFile::writeByBins(const std::string filename, const std::string group, const std::string variable,
